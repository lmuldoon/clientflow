 ...
 *
 * Variables available from ClientFlow::render_proposals():
 *   (none — all data is passed via cfData via wp_localize_script)
 *
 * @package ClientFlow
 * @since   0.1.0
 */
...
?>
<div class="cf-proposals-page">
	<div id="cf-proposals-root">
		<?php
		/*
		...
		">
			<div style="text-align: center; color: #64748B;">
				...
				<p style="margin: 0; font-size: 14px;">
					<?php esc_html_e( 'Loading Proposals…', 'clientflow' ); ?>
				</p>
			</div>
		</div>
		...
		<style>
			...
			/* Hide fallback once React mounts (React replaces innerHTML). */
			#cf-proposals-root:not(:empty) > #cf-loading-fallback:not(:only-child) {
				display: none;
			}
		</style>
	</div>
